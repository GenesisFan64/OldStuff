...
if len(sys.argv) < 2:
	print("Usage: inputfile outfoldername")
	exit()
...
output_art  = open(PROJFOLER+"/"+"art.bin","wb")
output_map  = open(PROJFOLER+"/"+"map.asm","w")
...
if PLC_MODE == True:
  ...
  output_dplc  = open(PROJFOLER+"/"+"plc.asm","w")
...
print("Art size:",hex(output_art.tell()))
