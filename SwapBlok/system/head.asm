...
; ----------------------------------------------------------------
		...
		dc.l MD_ErrorTrap
		dc.l MD_ErrorTrap
		dc.l RAM_GoToHBlnk		; VDP HBlank interrupt
		dc.l MD_ErrorTrap
		dc.l RAM_GoToVBlnk		; VDP VBlank interrupt
		dc.l MD_ErrorTrap
		dc.l MD_ErrorTrap
		dc.l MD_ErrorTrap
		dc.l MD_ErrorTrap
		...
		dc.b "(C)GF64 2020.SEP"					; "(C)[company] [year].[month]"
		dc.b "Puzzle Swap (2020 DEMO)                         " ; Your game title in your country
		dc.b "Puzzul Swap (2020 DEMO)                         "	; Your game title outside of your country
		dc.b "GM HOMEBREW-00"					; Serial number and version
		dc.w 0							; Checksum, leave it zero if not needed
		dc.b "J6              "					; Peripherals supported, "J" is 3-button controller
...
; 		dc.l $20FFFF
		...
		dc.l $20202020
		dc.l $20202020
		dc.b "A competitive puzzle game.              "		; Memo
