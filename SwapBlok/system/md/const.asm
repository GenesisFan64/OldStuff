...
Controller_3	equ RAM_InputData+(sizeof_input*2)
Controller_4	equ RAM_InputData+(sizeof_input*3)
...
; ----------------------------------------------------------------
		...
		struct RAM_MdSystem
RAM_GoToHBlnk	ds.w 3
RAM_GoToVBlnk	ds.w 3
RAM_InputData	ds.b sizeof_input*4		; 4 controller buffers
sizeof_mdsys	ds.l 0
		finish
...
; ----------------------------------------------------------------
		...
		struct RAM_MdVideo
RAM_FadeStart	ds.w 1
RAM_FadeEnd	ds.w 1
RAM_FadeTimer	ds.w 1
RAM_FadeBuff	ds.w 64
RAM_FadeTarget	ds.w 64
