...
; d1 | LONG - ROM bank | Track instruments (Z80 WORD)
...
.wait:
		...
		move.l	d0,d5
		or.w	#$8000,d4
		move.b	d4,Sample_Start(a4)
		lsr.w	#8,d4
		move.b	d4,Sample_Start+1(a4)
		lsr.l	#8,d5
		lsr.l	#7,d5
		move.b	d5,Sample_Start+2(a4)

		move.w	d1,d4
		move.l	d1,d5
		or.w	#$8000,d4
		move.b	d4,Sample_End(a4)
		lsr.w	#8,d4
		move.b	d4,Sample_End+1(a4)
		lsr.l	#8,d5
		lsr.l	#7,d5
		move.b	d5,Sample_End+2(a4)
		
		move.w	d2,d4
		move.l	d2,d5
		or.w	#$8000,d4
		move.b	d4,Sample_Loop(a4)
		lsr.w	#8,d4
		move.b	d4,Sample_Loop+1(a4)
		lsr.l	#8,d5
		lsr.l	#7,d5
		move.b	d5,Sample_Loop+2(a4)

		move.w	d3,d4
		move.b	d4,Sample_Speed(a4)
		lsr.w	#8,d4
		move.b	d4,Sample_Speed+1(a4)
		
		move.b	#%11,Sample_Flags(a4)
