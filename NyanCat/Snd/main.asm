...
RAM_SndDrv_MusicList	equ	$FFFF7000
RAM_SndDrv_SFXList	equ	$FFFF7004
...
PSG_Index:	dc.l PSG1, PSG2, PSG3
		dc.l PSG4, PSG5, PSG6
		dc.l PSG7, PSG8, PSG9
PSG1:		incbin	Snd\Data\psg1.bin
PSG2:		incbin	Snd\Data\psg2.bin
PSG3:		incbin	Snd\Data\psg3.bin
PSG4:		incbin	Snd\Data\psg4.bin
PSG6:		incbin	Snd\Data\psg6.bin
PSG5:		incbin	Snd\Data\psg5.bin
PSG7:		incbin	Snd\Data\psg7.bin
PSG8:		incbin	Snd\Data\psg8.bin
PSG9:		incbin	Snd\Data\psg9.bin
...
SoundDriverLoad:
		...
		lea	(Kos_Z80).l,a0
		lea	($A00000).l,a1
		move.w	#(Kos_Z80_End-Kos_Z80),d2
SndDriverLoad_Loop:
		move.b	(a0)+,(a1)+
		dbf	d2,SndDriverLoad_Loop
...
Calc_PCM2:
		...
		rts
;--------------------------------------------------------
Z80_DAC_RAM	equ	$A00200

PCM_Table:
		dc.l	Z80_DAC_RAM, DAC1		;$81
		dc.w	$352
		dc.b	$19,0
		dc.l	Z80_DAC_RAM+8, DAC2		;$82
		dc.w	$770
		dc.b	$4,0
		dc.l	Z80_DAC_RAM+8*2, DAC3		;$83
		dc.w	$576
		dc.b	$8,0
		dc.l	Z80_DAC_RAM+8*3, DAC4		;$84
		dc.w	$BB5
		dc.b	$A,0
		dc.l	Z80_DAC_RAM+8*4, DAC5		;$85
		dc.w	$1016
		dc.b	$1D,0
		dc.l	Z80_DAC_RAM+8*5, DAC6		;$86
		dc.w	$622
		dc.b	$C,0
		dc.l	Z80_DAC_RAM+8*6, DAC7		;$87
		dc.w	$5C4
		dc.b	$1D,0

                ;Extras
		dc.l	Z80_DAC_RAM+8*7, DAC5		;$88
		dc.w	$5C4
		dc.b	$14,0
		dc.l	Z80_DAC_RAM+8*8, DAC5		;$89
		dc.w	$5C4
		dc.b	$17,0
		dc.l	Z80_DAC_RAM+8*9, DAC5		;$8A
		dc.w	$5C4
		dc.b	$1E,0
		dc.l	Z80_DAC_RAM+8*$A, DAC5		;$8B
		dc.w	$5C4
		dc.b	$1F,0
		dc.l	Z80_DAC_RAM+8*$B, DAC6		;$8C
		dc.w	$5C4
		dc.b	4,0
		dc.l	Z80_DAC_RAM+8*$C, DAC6		;$8D
		dc.w	$5C4
		dc.b	7,0
		dc.l	Z80_DAC_RAM+8*$D, DAC6		;$8E
		dc.w	$5C4
		dc.b	$A,0
		dc.l	Z80_DAC_RAM+8*$E, DAC7		;$8F
		dc.w	$5C4
		dc.b	$A,0
		dc.l	Z80_DAC_RAM+8*$F, DAC7		;$90
		dc.w	$5C4
		dc.b	$D,0
		dc.l	Z80_DAC_RAM+8*$10, DAC7		;$91
		dc.w	$5C4
		dc.b	$14,0
		dc.l	Z80_DAC_RAM+8*$11, DAC7		;$92
		dc.w	$5C4
		dc.b	$1D,0
		dc.l	Z80_DAC_RAM+8*$12, PLM_ITSMAGIC
		dc.w	((PLM_ITSMAGIC_END-PLM_ITSMAGIC)/2)-$10
		dc.b	$A
		dc.b	0

;--------------------------------------------------------
Kos_Z80:
		incbin	Snd\Data\z80_u.bin
Kos_Z80_End:
		even
...
Music81:
		...
		even
Music82:
		incbin	snd/thf_82.bin
		even

Snd_RAM_MaxChn	equ	$A4F

Snd_RAM:
		dc.w Snd_RAM_Voice-Snd_RAM		;Voice bank

		dc.w $0603			;Channels modifier
		dc.w $0103			;Tempo

		dc.w Snd_RAM_DAC-Snd_RAM	;DAC Pointer
		dc.w 0				;Unused

		dc.w Snd_RAM_FM1-Snd_RAM	;FM Pointer
		dc.w $0008			;Pitch,Volume

		dc.w Snd_RAM_FM2-Snd_RAM	;FM Pointer
		dc.w $0008			;Pitch,Volume

		dc.w Snd_RAM_FM3-Snd_RAM	;FM Pointer
		dc.w $0008			;Pitch,Volume

		dc.w Snd_RAM_FM4-Snd_RAM	;FM Pointer
		dc.w $0008			;Pitch,Volume

		dc.w Snd_RAM_FM5-Snd_RAM	;FM Pointer
		dc.w $0008			;Pitch,Volume

		dc.w Snd_RAM_PSG1-Snd_RAM	;PSG Pointer
		dc.w $0008			;Pitch,Volume
		dc.w 0				;PSG Instrument

		dc.w Snd_RAM_PSG2-Snd_RAM	;PSG Pointer
		dc.w $0008			;Pitch,Volume
		dc.w 0				;PSG Instrument

		dc.w Snd_RAM_PSG3-Snd_RAM	;PSG Pointer
		dc.w $0008			;Pitch,Volume
		dc.w 0				;PSG Instrument
		even
Snd_RAM_DAC:
		dcb.b	Snd_RAM_MaxChn,0
		dc.b	$F2
...
SoundA0:	incbin	Snd\Data\soundA0.bin
		even
SoundA1:	incbin	Snd\Data\soundA1.bin
		even
SoundA2:	incbin	Snd\Data\soundA2.bin
		even
SoundA3:	incbin	Snd\Data\soundA3.bin
		even
SoundA4:	incbin	Snd\Data\soundA4.bin
		even
SoundA5:	incbin	Snd\Data\soundA5.bin
		even
SoundA6:	incbin	Snd\Data\soundA6.bin
		even
SoundA7:	incbin	Snd\Data\soundA7.bin
		even
SoundA8:	incbin	Snd\Data\soundA8.bin
		even
SoundA9:	incbin	Snd\Data\soundA9.bin
		even
SoundAA:	incbin	Snd\Data\soundAA.bin
		even
SoundAB:	incbin	Snd\Data\soundAB.bin
		even
SoundAC:	incbin	Snd\Data\soundAC.bin
		even
SoundAD:	incbin	Snd\Data\soundAD.bin
		even
SoundAE:	incbin	Snd\Data\soundAE.bin
		even
SoundAF:	incbin	Snd\Data\soundAF.bin
		even
SoundB0:	incbin	Snd\Data\soundB0.bin
		even
SoundB1:	incbin	Snd\Data\soundB1.bin
		even
SoundB2:	incbin	Snd\Data\soundB2.bin
		even
SoundB3:	incbin	Snd\Data\soundB3.bin
		even
SoundB4:	incbin	Snd\Data\soundB4.bin
		even
SoundB5:	incbin	Snd\Data\soundB5.bin
		even
SoundB6:	incbin	Snd\Data\soundB6.bin
		even
SoundB7:	incbin	Snd\Data\soundB7.bin
		even
SoundB8:	incbin	Snd\Data\soundB8.bin
		even
SoundB9:	incbin	Snd\Data\soundB9.bin
		even
SoundBA:	incbin	Snd\Data\soundBA.bin
		even
SoundBB:	incbin	Snd\Data\soundBB.bin
		even
SoundBC:	incbin	Snd\Data\soundBC.bin
		even
SoundBD:	incbin	Snd\Data\soundBD.bin
		even
SoundBE:	incbin	Snd\Data\soundBE.bin
		even
SoundBF:	incbin	Snd\Data\soundBF.bin
		even
SoundC0:	incbin	Snd\Data\soundC0.bin
		even
SoundC1:	incbin	Snd\Data\soundC1.bin
		even
SoundC2:	incbin	Snd\Data\soundC2.bin
		even
SoundC3:	incbin	Snd\Data\soundC3.bin
		even
SoundC4:	incbin	Snd\Data\soundC4.bin
		even
SoundC5:	incbin	Snd\Data\soundC5.bin
		even
SoundC6:	incbin	Snd\Data\soundC6.bin
		even
SoundC7:	incbin	Snd\Data\soundC7.bin
		even
SoundC8:	incbin	Snd\Data\soundC8.bin
		even
SoundC9:	incbin	Snd\Data\soundC9.bin
		even
SoundCA:	incbin	Snd\Data\soundCA.bin
		even
SoundCB:	incbin	Snd\Data\soundCB.bin
		even
SoundCC:	incbin	Snd\Data\soundCC.bin
		even
SoundCD:	incbin	Snd\Data\soundCD.bin
		even
SoundCE:	incbin	Snd\Data\soundCE.bin
		even
SoundCF:	incbin	Snd\Data\soundCF.bin
		even
SoundD0:	incbin	Snd\Data\soundD0.bin
		even
SoundD1:	incbin	Snd\Data\soundD1.bin
		even
SoundD2:	incbin	Snd\Data\soundD2.bin
		even
SoundD3:	incbin	Snd\Data\soundD3.bin
		even
SoundD4:	incbin	Snd\Data\soundD4.bin
		even
SoundD5:	incbin	Snd\Data\soundD5.bin
		even
SoundD6:	incbin	Snd\Data\soundD6.bin
		even
SoundD7:	incbin	Snd\Data\soundD7.bin
		even
SoundD8:	incbin	Snd\Data\soundD8.bin
		even
SoundD9:	incbin	Snd\Data\soundD9.bin
		even
SoundDA:	incbin	Snd\Data\soundDA.bin
		even
SoundDB:	incbin	Snd\Data\soundDB.bin
		even
SoundDC:	incbin	Snd\Data\soundDC.bin
		even
SoundDD:	incbin	Snd\Data\soundDD.bin
		even
SoundDE:	incbin	Snd\Data\soundDE.bin
		even
SoundDF:	incbin	Snd\Data\soundDF.bin
		even
SoundE0:	incbin	Snd\Data\soundE0.bin
		even
SoundE1:	incbin	Snd\Data\soundE1.bin
		even
SoundE2:	incbin	Snd\Data\soundE2.bin
		even
SoundE3:	incbin	Snd\Data\soundE3.bin
		even
SoundE4:	incbin	Snd\Data\soundE4.bin
		even
SoundE5:	incbin	Snd\Data\soundE5.bin
		even
SoundE6:	incbin	Snd\Data\soundE6.bin
		even
SoundE7:	incbin	Snd\Data\soundE7.bin
		even
SoundE8:	incbin	Snd\Data\soundE8.bin
		even
SoundE9:	incbin	Snd\Data\soundE9.bin
		even
SoundEA:	incbin	Snd\Data\soundEA.bin
		even
SoundEB:	incbin	Snd\Data\soundEB.bin
		even
SoundEC:	incbin	Snd\Data\soundEC.bin
		even
SoundED:	incbin	Snd\Data\soundED.bin
		even
SoundEE:	incbin	Snd\Data\soundEE.bin
		even
SoundEF:	incbin	Snd\Data\soundEF.bin
		even
SoundF0:	incbin	Snd\Data\soundF0.bin
		even


		cnop 0,$8000
DAC1: incbin Snd\Data\dac1d.bin
		even
DAC2: incbin Snd\Data\dac2d.bin
		even
DAC3: incbin Snd\Data\dac3d.bin
		even
DAC4: incbin Snd\Data\dac4d.bin
		even
DAC5: incbin Snd\Data\dac5d.bin
		even
DAC6: incbin Snd\Data\dac6d.bin
		even
DAC7: incbin Snd\Data\dac7d.bin
		even

		cnop 0,$8000
PLM_YAY:		incbin	"Snd\Data\YAY.bin"
PLM_YAY_END:		even

		cnop 0,$8000
PLM_ITSMAGIC:		incbin	"Snd\Data\ItsMagic.bin"
PLM_ITSMAGIC_END:	even
