...
sprpos_y_list = [0x80,0x88,0x90,0x98,0xA0,0xA8,0xB0,0xB8,0xC0,0xC8,0xD0,0xD8,0xE0,0xE8,0xF0,0xF8]
...
# ----------------------------
  ...
  while mapping:
	...
	plc_cell = '%x' % dplc_cell
        ...
        output_dplcd.write("\t\tdc.w $")
        output_dplcd.write(str(plc_size).upper())
        output_dplcd.write(",$")
        output_dplcd.write(str(plc_cell).upper())
        output_dplcd.write("\n")
        off_d_plc_entries = output_dplcd.tell()
        #dplc_cell = cell_used
